...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      {/* <Header /> */}
      <div className="text-yellow-300 text-9xl">쌀로아</div>
      <div className="flex flex-row flex justify-around">
        {/* <div className="box-border h-60 w-60 p-4 border-8 grid grid-cols-1 gap-2 justify-items-center m-5 hidden md:table-cell">
